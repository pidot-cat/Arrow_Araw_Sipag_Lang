...
class _State extends State<GameScreenLvl9> with BentLevelStateMixin<GameScreenLvl9> {
  ...
  @override int get arrowCount => Level9Manager.build().length;
  ...
  Widget build(BuildContext context) {
    ...
    final cellSize = dynamicCellSize(
      ...
      arrowCount: Level9Manager.build().length,
    );
    ...
    return Scaffold(
      ...
      body: Stack(children: [
        SafeArea(child: Column(children: [
          ...
          Text('Solid Square · $rows×$cols · ${Level9Manager.build().length} Arrows',
