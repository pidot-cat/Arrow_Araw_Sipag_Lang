...
class GameProvider with ChangeNotifier {
  ...
  /// Clears all stats locally. Called on account deletion.
  ...
  /// Explicitly clear all data from Supabase for this user.
  /// This ensures that if they sign up again with the same email, they start fresh.
  Future<void> clearRemoteData() async {
    try {
      final zeroStats = GameStatsModel();
      await SupabaseService.saveGameStats(zeroStats);
    } catch (e) {
      debugPrint('Error clearing remote data: $e');
    }
  }
