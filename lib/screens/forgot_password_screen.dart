...
// UPDATED: Added password visibility toggle to step 3.
...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  bool _obscureConfirmPassword = true; // Added state for confirm password visibility
        ...
        Container(
          decoration: BoxDecoration(
            gradient: const LinearGradient(
              colors: [Color(0xFF271E9A), Color(0xFF212125)],
            ),
